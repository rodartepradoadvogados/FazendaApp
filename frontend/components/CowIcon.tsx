...
export function CowIcon({ size = 24, color = "#2b2b2b", strokeWidth = 1.1 }: { size?: number; color?: string; strokeWidth?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true">
      {/* orelhas */}
      <ellipse cx="4.6" cy="8.4" rx="2.3" ry="2.9" fill="#fff" stroke={color} strokeWidth={strokeWidth} />
      <ellipse cx="19.4" cy="8.4" rx="2.3" ry="2.9" fill="#fff" stroke={color} strokeWidth={strokeWidth} />
      {/* cabeça */}
      <ellipse cx="12" cy="12.6" rx="7.9" ry="7" fill="#fff" stroke={color} strokeWidth={strokeWidth * 1.09} />
      {/* manchinhas pretas */}
      ...
      {/* focinho */}
      <ellipse cx="12" cy="16.9" rx="4.4" ry="2.8" fill="#fff" stroke={color} strokeWidth={strokeWidth} />
