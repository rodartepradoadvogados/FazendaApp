...
export function TabsShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div style={{ height: "calc(100vh - var(--faixas-topo-h, 0px))", position: "relative", display: "flex", flexDirection: "column" }}>
      ...
      {temAbasExtras && (
        ...
        <div
          ...
          style={{
            position: "fixed", top: "var(--faixas-topo-h, 0px)", right: 0, zIndex: 65,
      ...
      {aviso && (
        <div
          ...
          className="hidden md:flex left-0 md:left-56"
          style={{
            position: "fixed", right: 0, top: temAbasExtras ? "calc(2.2rem + var(--faixas-topo-h, 0px))" : "var(--faixas-topo-h, 0px)", zIndex: 64,
