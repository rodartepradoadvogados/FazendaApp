"""remove contrato_consultor/fazenda_gerenciada/registro_importado (produto independente do consultor, ver backlog #122)

Revision ID: 13fe8233d2c1
Revises: 260219cd5331
...
revision: str = '13fe8233d2c1'
down_revision: Union[str, Sequence[str], None] = '260219cd5331'
...
def upgrade() -> None:
    """Upgrade schema."""
    # Produto independente do consultor (Fase 2C) removido — consultor passa a
    # ser sempre um "Consultor CowData" (membro de Equipe CowData com login)
    # vinculado a uma fazenda-cliente via plano Diamond/sob medida, não mais
    # uma assinatura própria do consultor. Nenhuma outra tabela tem FK para
    # estas três (ver backend/fazenda/models/consultores.py, removido nesta
    # mesma leva) — ordem de drop respeita a única FK interna (registro_importado
    # -> fazenda_gerenciada).
